...
export class CreateUsersLambda extends lambda.Function {
  constructor(scope: cdk.Stack, props: Lambdas.LambdasProps) {
    ...
    const params: lambda.FunctionProps = {
      ...
      code: lambda.Code.fromAsset('dist/lib/lambdas/users/createUsers'),
    };

    super(scope, 'CreateUsersLambda', params);
  }
}
