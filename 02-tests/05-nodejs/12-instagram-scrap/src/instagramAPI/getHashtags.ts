import { instagramAPIHeaders, instagramAPIIndentity } from "./util";
...
export const getHashtags = async (hashtagName: string) => {
  try {
    ...
    const request: RequestInit = {
      ...
      body: `${instagramAPIIndentity}&variables=${encoded}&server_timestamps=true&doc_id=6460896210645763`,
      method: "POST",
    };
    ...
    const hashtagArr = queryResult["hashtags"]?.map(
